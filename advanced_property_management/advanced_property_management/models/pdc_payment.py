...
class PdcProperty(models.Model):
    ...
    def action_done(self):
        ...
        self.env.ref(
            'advanced_property_management.send_email_done').sudo().send_mail(self.id, force_send=True,
    ...
    def action_register(self):
        ...
        self.env.ref(
            'advanced_property_management.send_email_to_register').sudo().send_mail(self.id, force_send=True, email_values=email_values)
        return res
    ...
    def action_deposited(self):
        ...
        self.env.ref(
            'advanced_property_management.send_email_deposit').sudo().send_mail(self.id, force_send=True, email_values=email_values)
        return res
