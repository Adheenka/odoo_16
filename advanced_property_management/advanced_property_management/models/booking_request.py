...
class Apartment_Booking(models.Model):
    ...
    # show_apartment = fields.Boolean(string="show",default =False)
    ...
    property_category = fields.Selection(
        ...
        default="apartment",
        required=True,
        related = 'property_id.property_category')

    # @api.onchange('property_id')
    # def _get_apartment_field(self):
    #     show_apartment = False
    #     for rec in self:
    #         if rec.property_id:
    #             if rec.property_id.property_category =="apartment":
    #                 show_apartment = True
    #         rec.show_apartment = show_apartment
    ...
    def action_view_contract(self):
        return {
            ...
            "res_model": "property.rental",
            "type": "ir.actions.act_window",
            "domain": [("related_booking_id", "=", self.id)],
        }
